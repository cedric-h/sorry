...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "cspeudo.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "cspeudo.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'cspeudo'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'cspeudo':", error );
                    throw error;
                });
        }
    }( function() {
...
function input(prompt_string) {
    ...
    return {
        imports: {
            env: {
                "__cargo_web_snippet_374b7c54d8f22fabdff3bf4874c2868213de384e": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return input(($1));})());
            },
            ...
            "__cargo_web_snippet_e3c0e1b22c1ca16eceb251f59a7c74f525500042": function($0) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);display(($0))
            },
        ...
        initialize: function( instance ) {
            ...
            Module.exports.interpret = function interpret(source) {
    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.interpret(Module.STDWEB_PRIVATE.prepare_any_arg(source)));
}
;
            __web_on_grow();
