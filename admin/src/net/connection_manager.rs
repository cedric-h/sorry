...
// reexports/main lib
use comn::{rmps, specs, NetComponent, NetMessage};
...
impl ConnectionManager {
    fn new() -> Self {
        let (to_thread, from_clients) = bounded(5);
        let (to_clients, from_thread) = bounded(5);
        ...
        spawn(move || {
            ...
            for stream in server.incoming() {
                ...
                let (channels_s, msgs_to_send) = bounded(5);
                channels
                    .lock()
